...
$(function() {
    ...
    var options = {
        center: {lat: -33.907643, lng: 151.1811053}, // -33.907643,151.1811053  42.3770, lng: -71.1256
    ...
    marker.addListener('click', function() {
        ...
        .done(function(data, textStatus, jqXHR) {
            ...
            $.each( data, function( key, value ) {
                items+=( "<li><a href='" + value.link + "' target='_blank'>" + value.title + "</a></li>" );
            });
